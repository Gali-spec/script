...
newsInfo = {
  ...
  "Ты гей? Не беда! Твоя дорога в LVa!",
  ...
  lua_thread.create(function()
    ...
    if #files > 0 or #direct > 0 then
      ...
      for k, v in pairs(files) do
        ...
        downloadUrlToFile('-v, 'moonloader/lib/'..v, function(id, status, p1, p2)
...
-- Автообновление
function autoupdate()
  local updateUrl = string.format("", DEBUG_MODE and "develop" or "master")
